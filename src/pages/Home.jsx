...
import Feed from "../components/main/Feed.jsx";
  ...
  return (
    <div className="flex flex-col w-2/3">
      ...
      <div className="flex gap-2 items-start py-5 px-8 cursor-pointer border-b border-b-gray-600">
        <img
          className="rounded-full w-12 h-12 overflow-hidden object-cover"
        ...
        <form className="flex flex-col grow divide-y">
          <textarea
            className="indent-2 h-28 bg-transparent hover:outline-none hover:border-none focus:outline-none focus:border-none"
          ...
          <div className="flex justify-between items-center">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-10 h-10 hover:bg-gray-600 rounded-full p-2 hover:text-green-500"
            >
              <path
                strokeLinecap="round"
